...
export const getAllEmrImageHandler = async (req: IRequest, res: IResponse, next: NextFunction) => {
    try {
...
export const getAllEmrImages = async (req: IRequest, res: IResponse, next: NextFunction) => {
    await handle(getAllEmrImageHandler, 400)(req, res, next);
};



export const getemrImageByIdHandler = async (req: IRequest, res: IResponse, next: NextFunction) => {
...
export const getemrImageById = async (req: IRequest, res: IResponse, next: NextFunction) => {
    await handle(getemrImageByIdHandler, 404)
    (req, res, next);
}


export const newEmrImage = async (req: IRequest, res: IResponse, next: NextFunction) => {
...
export const updateEmrImage = async (req: IRequest, res: IResponse, next: NextFunction) => {
    let emrImageId = req.params['emrImageId'];
    ...
    try {
        const updateEmrImage = await emrImageService.updateEMRImage(emrImageId,emrImage);
...
export const deleteEmrImage = async (req: IRequest, res: IResponse, next: NextFunction) => {
    let emrImageId = req.params['emrImageId'];
