...
export const getAllEMRs = async (req: IRequest, res: IResponse, next: NextFunction) => {
...
export const getEMRById = async (req: IRequest, res: IResponse, next: NextFunction) => {
    await handle(getEMRByIdHandler, 404)
    (req, res, next);
}


export const newEMR = async (req: IRequest, res: IResponse, next: NextFunction) => {
...
export const updateEMR = async (req: IRequest, res: IResponse, next: NextFunction) => {
    let emrId = req.params['emrId'];
...
export const deleteEMR = async (req: IRequest, res: IResponse, next: NextFunction) => {
    let emrId = req.params['emrId'];
