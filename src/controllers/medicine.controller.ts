...
export const getAllMedicineHandler = async (
  req: IRequest,
  res: IResponse,
  next: NextFunction,
) => {
...
export const getAllMedicineHandlerWithPagination = async (
  req: IRequest,
  res: IResponse,
  next: NextFunction,
) => {
  ...
  try {
    ...
    const { data, total } =
      await medicineService.getAllMedicinesWithPagination(query);
...
export const getMedicineByIdHandler = async (
  ...
  if (!medicine)
    throw Error('No MedicineModel found you search by id :' + medicineId);
...
export const getMedicineById = async (
  ...
  await handle(getMedicineByIdHandler, 404)(req, res, next);
};

export const findMedicineByName = async (
  req: IRequest,
  res: IResponse,
  next: NextFunction,
) => {
...
export const newMedicine = async (
  req: IRequest,
  res: IResponse,
  next: NextFunction,
) => {
